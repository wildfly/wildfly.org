...
[source,jsonlines]
----
AiMessage { text = "Nice to meet you, Tom. Is there something I can help you with or would you like to chat?" toolExecutionRequests = null }
----
