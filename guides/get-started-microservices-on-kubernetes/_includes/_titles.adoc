...
:simple-microservice-llm-part1: Invoke an LLM using LangChain4J - PART 1: Container Image
:simple-microservice-llm-part2: Invoke an LLM using LangChain4J - PART 2: Kubernetes
