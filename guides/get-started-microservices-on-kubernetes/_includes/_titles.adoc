:simple-microservice-part1: Simple WildFly Java Microservice - PART 1: Docker Image
:simple-microservice-part2: Simple WildFly Java Microservice - PART 2: Kubernetes
