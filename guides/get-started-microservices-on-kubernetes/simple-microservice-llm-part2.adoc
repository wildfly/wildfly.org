...
In this guide, you will learn HOW-TO run the Docker Image we built in link:simple-microservice-llm-part1[{simple-microservice-llm-part2}] on Kubernetes.
...
* Complete link:simple-microservice-llm-part2[{simple-microservice-llm-part2}]

include::_includes/_constants.adoc[]

== LLM

We basically will repeat everything we did in link:simple-microservice-part2[{simple-microservice-part2}] but, before, we will deploy `{ollama-llm}` on Kubernetes using the Ollama container.
...
Open link:http://192.168.39.178:30781/api/tommaso/[http://192.168.39.178:30781/api/tommaso] in your Browser and you should receive
an answer like:

[source,jsonlines,subs="normal"]
----
AiMessage { text = "Hello Tommaso. It's nice to meet you! How can I assist you today?" toolExecutionRequests = null }
----
...
* link:https://www.wildfly.org/news/2024/11/04/WildFly-playing-with-generative-ai/[Playing with Generative AI with WildFly]: contains a Retrieval-Augmented Generation (RAG) example application
* link:https://www.youtube.com/watch?v=d8IExBP7rxw&t=11425s[WildFly Mini Conference March 2025]: check the last track which is about link:https://modelcontextprotocol.io/introduction[MCP]
