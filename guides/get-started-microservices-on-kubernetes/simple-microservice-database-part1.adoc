...
We will use PostgreSQL in this post in its containerized version: see link:https://hub.docker.com/_/postgres[PostgreSQL Official Image, window="_blank"];
...
You will extend the sample application you created in link:simple-microservice-part1[{simple-microservice-part1}] by adding the link:https://github.com/wildfly-extras/wildfly-datasources-galleon-pack[wildfly-datasources-galleon-pack, window="_blank"];
