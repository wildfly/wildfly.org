...
.org.wildfly.examples.model.TestTable   :
[source,java]
----
...
.org.wildfly.examples.model.TestTableResource :
[source,java]
----
...
podman run --rm -p 8080:8080 -p 9990:9990 \
    ...
    -e POSTGRESQL_HOST=host.containers.internal \
...
----
$ curl -X POST http://localhost:8080/hello/test-table/insert/somedata1/somedata2
{"field1":"somedata1","field2":"somedata2","id":2}
----
...
----
$ curl http://localhost:8080/hello/test-table/list
[{"field1":"somedata1","field2":"somedata2","id":1},{"field1":"somedata1","field2":"somedata2","id":2}]
----
