...
In this guide, you will learn HOW-TO run the Docker Image we built in link:simple-microservice-jms-part1[{simple-microservice-jms-part1}] on Kubernetes.
...
* Source code for this guide: {source-code-git-repository}/tree/simple-microservice-jms-part2
