...
There are many Image Registries you can use: in this post, we will push the `{my-jaxrs-app-docker-image-name}:latest` Docker Image, to the link:https://quay.io[quay.io, window="_blank"] Image Registry;
