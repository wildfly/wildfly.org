...
In this guide, you will learn HOW-TO run the Docker Image you built in link:simple-microservice-part1[{simple-microservice-part1}] on Kubernetes.
...
* Source code for this guide: {source-code-git-repository}/tree/simple-microservice-part2
