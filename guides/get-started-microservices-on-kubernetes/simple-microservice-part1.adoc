...
* Install link:https://www.docker.com/[Docker] or link:https://podman.io/[Podman]

include::_includes/_constants.adoc[]

== Maven Project

Create a simple Jakarta EE application Maven Project containing a link:https://jakarta.ee/specifications/restful-ws/[Jakarta RESTful Web Service] using the `org.wildfly.archetype:wildfly-getting-started-archetype` archetype:
...
NOTE: See link:/get-started[Getting Started with WildFly] for the details
...
We can add these features by adding the link:https://github.com/wildfly-extras/wildfly-cloud-galleon-pack[wildfly-cloud-galleon-pack] to our application; add the following to the link:https://github.com/wildfly/wildfly-maven-plugin/[wildfly-maven-plugin] configuration in the `pom.xml` file:
...
We will use the Dockerfile from link:https://github.com/wildfly/wildfly-s2i/blob/main/examples/docker-build/Dockerfile[examples/docker-build/Dockerfile] because it is crafted specifically for WildFly;
