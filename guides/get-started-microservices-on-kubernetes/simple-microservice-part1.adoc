...
In this guide, you will learn how to create and run a link:https://docs.docker.com/guides/docker-concepts/the-basics/what-is-an-image/[Docker Image] containing a link:https://jakarta.ee/specifications/restful-ws/[Jakarta RESTful Web Service] implemented using WildFly.
...
Everything works fine! Let's move on and package our application inside a link:https://docs.docker.com/guides/docker-concepts/the-basics/what-is-an-image/[Docker Image] ...
...
link:https://kubernetes.io/[Kubernetes]: link:simple-microservice-part2[{simple-microservice-part2}]
