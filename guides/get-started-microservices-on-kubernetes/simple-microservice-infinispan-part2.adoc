...
Create a public repository named `{my-jaxrs-app-infinispan-docker-image-name}` on link:quay.io[quay.io] (e.g. link:https://quay.io/repository/{quay-io-account-name}/{my-jaxrs-app-infinispan-docker-image-name}[https://quay.io/repository/{quay-io-account-name}/{my-jaxrs-app-infinispan-docker-image-name}]);
