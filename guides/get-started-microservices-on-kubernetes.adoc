...
In this series, you'll learn HOW-TO to build applications using some of the most common link:https://jakarta.ee/[Jakarta EE, window="_blank"] specifications (e.g. JAX-RS, JPA, JMS, etc.) and run them on link:https://kubernetes.io/[Kubernetes, window="_blank"];

At some point, we'll go even further and use some link:https://microprofile.io/[MicroProfile, window="_blank"] specifications (e.g. Rest Client invoking a JAX-RS service in another application);
