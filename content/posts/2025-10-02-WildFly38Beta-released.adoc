...
* **Java EE 11 Integration:** A key new feature is the implementation of link:https://issues.redhat.com/browse/WFLY-19554[EE 11 JPA and CDI integration] in WildFly Preview, bringing us closer to full support for the latest Jakarta specifications.
