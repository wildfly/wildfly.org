...
writing EE applications for WildFly. For the purpose of this test, we will use the
...
The above configuration will provision a server based with EE Core Profile specifications, Jakarta Persistence,
