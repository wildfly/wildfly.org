...
The full list of issues resolved in WildFly 18.0.1 is available link:https://issues.jboss.org/secure/ReleaseNote.jspa?projectId=12313721&version=12343077[here]. Issues resolved in the WildFly Core 10.0.2 and 10.0.3 releases included with WildFly 18.0.1 are available link:https://issues.jboss.org/secure/ReleaseNote.jspa?projectId=12315422&version=12343078[here] and link:https://issues.jboss.org/secure/ReleaseNote.jspa?projectId=12315422&version=12343166[here].
