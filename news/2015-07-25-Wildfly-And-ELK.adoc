...
If you don't have a local install of WildFly you'll want to link://wildfly.org/downloads/[download] a recent version. In my example I'll be use http://download.jboss.org/wildfly/9.0.1.Final/wildfly-9.0.1.Final.zip[WildFly 9.0.1.Final]. However any other version should work the same.
