...
* CMP - JPA replaces, and is a much more performant and flexible API
* JAX-RPC - JAX-WS replaces, and offers a much more accurate and complete solution
* JSR-88 - Very little adoption, most preferred the more complete deployment APIs provided by venders
