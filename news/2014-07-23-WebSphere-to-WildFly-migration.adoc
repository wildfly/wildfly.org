...
|Installation| Installation requires an extra program (Installation Manager), that would download or import huge files (2BG) containing the app server( Full Profile) . You need some time to get started and is not easily 'scriptable' to set up a running development server |Installation is easy, you can either download a 127 MB zip or even add a Maven task to download the full server as a dependency, then unpack the server in any custom folder and you are ready to go
...
|Maven support | No official Maven Plugin for Websphere Full Profule| Wildfly 8.1 has an official Maven Plugin
|Pre / Post deployment settings | No official Maven Plugin for Websphere Full Profule| Wildfly 8.1
|Shared libraries and class loaders | No official Maven Plugin for Websphere Full Profule| Wildfly 8.1
|=============================================================================================================================
