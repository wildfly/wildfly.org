...
|Installation| Installation requires an extra program (Installation Manager), that would download or import huge files (2BG) containing the app server( Full Profile) . You need some time to get started and is not easily 'scriptable' to set up a running development server. Also update packages can not be downloaded and applied as standalone fixes. You need to download and save offline all the repository in order to apply updates (if you are not using the online update) | Installation is easy, you can either download a 127 MB zip or even add a Maven task to download the full server as a dependency, then unpack the server in any custom folder and you are ready to go
|=============================================================================================================================
