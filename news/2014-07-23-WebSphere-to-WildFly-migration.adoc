...
-------------------------------------------------------------------------------------------
Working towards API(s) defined in the context of JavaEE and application servers that follow the specification was of course the domimant reason and force behind switching from on server to another. 
