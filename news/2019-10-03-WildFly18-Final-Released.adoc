...
* The HAL web console includes link:https://issues.jboss.org/issues/?filter=12341194[numerous new features and enhancements].
...
Jira Release Notes
------------------
The full list of issues resolved is available link:https://issues.jboss.org/secure/ReleaseNote.jspa?projectId=12313721&version=12342528[here]. Issues resolved in the WildFly Core 10 releases included with WildFly 18 are available link:https://issues.jboss.org/secure/ReleaseNote.jspa?projectId=12315422&version=12342773[here].
