...
== Use case
A simple WildFly JAX-RS based Bootable JAR application that exposes an endpoint for greeting the user will be our
...
configuration which will allow for us to leverage Jakarta EE components, like for instance the JAX-RS API implementation:
