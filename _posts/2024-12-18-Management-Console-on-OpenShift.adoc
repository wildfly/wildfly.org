...
* Please do not use the https://quay.io/repository/halconsole/wildfly[quay.io/halconsole/wildfly] images in production. It contains preconfigured, insecure credentials and is meant only for development and testing purposes.
