...
The Secondary Host Controller on Machine B will use the `host-secondary.xml` as its configuration file. We need to make some modifications to this file. First I need to add the `name` property to the `host` section:
