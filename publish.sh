...
# team email subject
EMAIL_SUBJECT="WildFly site released at \${PRODUCTION_URL}"
# email To ?
EMAIL_TO=""
EMAIL_FROM="\"WildFly Site Publish Script\" <benevides@redhat.com>"

JBORG_DIR="wildfly"
JBORG_REPO="filemgmt.jboss.org:www_htdocs"

STAGING_URL="wildfly.org/staging"
STAGING_DIR="${JBORG_DIR}/staging"

PRODUCTION_DIR="${JBORG_DIR}"
PRODUCTION_URL="www.wildfly.org"


notify_email()
{
   echo "***** Performing WildFly site release notifications"
   echo "*** Notifying WildFly dev list"
...
This script publishes the WildFly site, either to sandbox, staging or to production
